#write a python class bankaccount with attributes like account number,balance,date of opening,and customer name and methods like deposit,withdraw and check balance.
class BankAccount:
